...
const ImageUploader: React.FC = () => {
  ...
  const onProcess = async () => {
    ...
    img.onload = async () => {
      ...
      const svgResult = await GUIProcessManager.process(settings, tokenRef.current.token, canvasRef.current);
      GUIProcessManager.createSVG(svgRef.current, svgResult.facetResult, svgResult.colorsByIndex, 1, true, true, true, 50, "#000", (progress) => {})
    };
  }
