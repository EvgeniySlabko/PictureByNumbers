export function fill(x: number, y: number, width: number, height: number, visited: any, setFill: any) {
...
export function fillCore(x: number, y: number, width: number, height: number, visited: any, setFill: any) {
