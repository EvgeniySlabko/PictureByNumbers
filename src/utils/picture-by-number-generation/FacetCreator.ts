...
import { Uint32Array2D } from "./common/arrays/Uint32Array2D";
import { Uint8Array2D } from "./common/arrays/Uint8Array2D";
import { BoundingBox } from "./common/BoundingBox";
import { fill } from "./common/common";
...
export class FacetCreator {
  ...
  static async getFacets(
    ...
    const result: FacetResult = {
      ...
      facetMap: new Uint32Array2D(width, height),
      facets: [],
    };
   ...
   */
  static buildFacetNeighbour(facet: Facet, facetResult: FacetResult) {
    facet.neighbourFacets = [];
    const uniqueFacets: {[key: number]: boolean} = {}; // poor man's set
